    ...
    <section className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <Link
            to="/signup"
            className="group px-8 py-3 bg-electric-blue hover:bg-electric-cyan text-white rounded-lg font-semibold transition-all shadow-glow-md hover:shadow-glow-lg flex items-center gap-2"
          >
            Start Free Trial
          ...
          <button
            ...
            className="px-8 py-3 bg-dark-surface hover:bg-dark-border text-white rounded-lg font-semibold transition-all border border-dark-border hover:border-electric-blue/50 flex items-center gap-2"
          >
